/*!
** \file utils.h
** \brief Implementations of utility functions for the
** [Open Data Structures](http://opendatastructures.org/) library
**
** ### About
...
**
** ## Primary Basis
** This is a copy of the utils.cpp file from [Open Data Structures](http://opendatastructures.org/)
